...
<div class="dropzone {containerClasses}" tabindex="0" role="button" style={containerStyles}
	bind:this={rootRef}
...
>
	<input {accept} {multiple} {required} type="file" {name} autocomplete="off" tabindex="-1" on:change={onDropCb} on:click={onInputElementClick} bind:this={inputElement} style="display: none;" />
	<slot>
